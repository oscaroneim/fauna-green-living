...
export default async function ContactPage() {
  return (
    <MaxWidthWrapper className="space-y-6">
      <div className="flex h-[673px] gap-x-10 bg-customLightGreen p-4 pt-4 xl:gap-x-32 xl:px-12 xl:pb-12">
        ...
        <Image
          className="h-full w-[508px] rounded-lg object-cover max-md:hidden"
          src={forest}
      ...
      <div className="h-[410px] rounded-lg bg-customDarkGreen text-white max-md:hidden">
        <h1>Need To Fill</h1>
      </div>
    </MaxWidthWrapper>
  );
