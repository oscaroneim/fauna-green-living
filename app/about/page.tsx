      ...
      <div className="mx-2">
        <div className="flex w-full gap-6 max-md:flex-col md:h-[520px] ">
          ...
          <div className="flex shrink-0 flex-col gap-y-6 md:basis-[500px] ">
            ...
            <div className="grow space-y-4 rounded-lg bg-customDarkGreen p-10 text-center text-white">
              ...
              <p className="text-xl ">
                At Fauna Green Living, we envisage ourselves helping each and every individual do
                what they can to bring sustainability and responsibility back into our purchasing
                habits. We are here to provide sustainable ways to make your home beautiful
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex w-full items-center justify-between gap-10 rounded-lg bg-customDarkGreen p-10 text-white max-md:flex-col  md:h-[664px] md:flex-row ">
          <div className=" flex flex-col gap-y-10 text-center md:w-1/2">
            ...
            <p className="text-xl">
              We opened our doors in August of 2022 because we wanted to make your homes, your
              lives, and our planet a better place. <br />
