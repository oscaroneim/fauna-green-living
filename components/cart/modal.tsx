    ...
    <>
      ...
      <Transition show={isOpen}>
        <Dialog onClose={closeCart} className="relative z-50">
          ...
          >
            <Dialog.Panel className="fixed bottom-0 right-0 top-0 flex h-full w-full flex-col bg-white p-6 text-customGreen backdrop-blur-xl md:w-[390px]">
                ...
                <div className="flex h-full flex-col justify-between overflow-hidden p-1">
                      ...
                      return (
                        <li key={i} className="flex w-full flex-col border-b border-neutral-300">
                          <div className="relative flex w-full flex-row justify-between px-1 py-4">
                            ...
                            >
                              <div className="bg-neutral-3000 relative h-16 w-16 cursor-pointer overflow-hidden rounded-md border border-neutral-300">
                                <Image
                            ...
                            <div className="flex h-16 flex-col justify-between">
                              ...
                              />
                              <div className="border-natural-500 ml-auto flex h-9 flex-row items-center rounded-full border text-customGreen">
                  ...
                  <div className="py-4 text-sm text-black">
                    <div className="mb-3 flex items-center justify-between border-b border-neutral-200 pb-1">
                      {/* <p>Taxes</p>
                      <Price
                        className="text-right text-base text-black e"
